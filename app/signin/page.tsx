      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          void signIn("password", formData)
            ...
            .then(async () => {
              // Always ensure a userProfile exists (idempotent).
              // This matters for admin-only workflows where admins may be set manually in the DB.
              try {
                await ensureUserProfile();
              } catch (err) {
                // Log error but don't block navigation - profile creation is idempotent

...
export function SimpleEditor({
    ...
    extensions: [
      ...
      Mathematics.configure({
        ...
        inlineOptions: {
          onClick: (node, pos) => {
            if (!editable) return;
            onMathEdit?.({ latex: node.attrs.latex, pos, type: "inline" });
          },
        },
        blockOptions: {
          onClick: (node, pos) => {
            if (!editable) return;
            onMathEdit?.({ latex: node.attrs.latex, pos, type: "block" });
          },
        },
      }),
  ...
  function cv(arg0: string, className: string): string | undefined {
